...
%% A classe ppgccufmg já carrega o hyperref internamente (necessário para
%% gerar PDF/A). Não use \usepackage{hyperref} aqui -- configure as opções
%% do pacote com \hypersetup{} (veja o README para mais detalhes).
\hypersetup{
	colorlinks=true,
